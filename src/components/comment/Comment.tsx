...
function Comment() {
  return (
    <>
              <div className="flex flex-col w-[800px] h-[250px] gap-5 mr-[-11px] justify-center items-center  ">
          <textarea
            className="textarea just  w-[800px] h-40 text-sm font-normal text-[rgba(69,90,100,1)] rounded-2xl focus:outline-none focus:border-none max-h-40 min-h-40"
        ...
        <div className="w-[800px] h-[100px]  mr-[-11px] ">
          ...
          <p className="w-[800px] h-[22px] text-[rgba(69,90,100,1)] text-sm font-normal line-clamp-1">
