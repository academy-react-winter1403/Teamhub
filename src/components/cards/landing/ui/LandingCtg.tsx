...
// import yellowRect from "../../../../assets/images/RectangleYellow.svg";
// import blueRect from "../../../../assets/images/RectangleBlue.svg";
  ...
  return (
    <div className="relative w-full h-[750px] mb-20">
      ...
      <div className="relative w-full h-120">
        {/* <img src={dotImg} className="absolute w-100 h-38 bottom-140 right-90" />
        <img
          src={EllipseImg}
          className="absolute size-32 bottom-140 right-160"
        />
        <img
          src={yellowRect}
          className="absolute w-250 h-120 bottom-160 left-0"
        />
        <img src={blueRect} className="absolute size-40 bottom-210 right-25" /> */}
