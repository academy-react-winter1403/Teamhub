...
const CardViewTwo = () => {
  return (
    <div className="bg-white relative shadow-md rounded-2xl mb-5 p-4 w-full h-45 flex gap-4" >
      ...
      />
      <span className="flex justify-around w-7 h-7 items-center bg-[url(/cardIcons/likes.svg)]  bg-no-repeat bg-center bg-pink-100 text-red-400 p-1 rounded-xl absolute top-5 right-5">
