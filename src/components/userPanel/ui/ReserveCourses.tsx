...
const ReserveCourses = () => {
  return (
    <>
      <div className="divider divider-neutral  text-xl ">دوره های رزرو شده</div>
      <div className="flex flex-col">
        ...
        <div className="w-full rounded-xl bg-white">
          {/* هد */}
          <div className="bg-[#3f40ea] h-12 rounded-xl text-white font-bold text-sm grid grid-cols-6 items-center px-5">
          ...
          <div className="flex flex-col py-3">
            {favoriteCourses.map((course) => (
              <div
                key={course.id}
                className="bg-[#E8E7FF] grid grid-cols-6 items-center px-5 py-3 text-sm rounded-lg mb-4 transition-transform duration-200 hover:scale-[1.01] "
              >
                {/* عنوان + آواتار */}
